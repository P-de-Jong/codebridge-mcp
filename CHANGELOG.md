...
- **Diagnostics Tool**: Auto-open target files and wait briefly so LSP diagnostics populate for unopened files

### ✨ Enhanced

- **Tool Guidance**: Clarified must-use guidance in diagnostics, references, and workspace symbols tool descriptions

## [1.0.3] - 2025-09-20

### 🔧 Fixed

- **C# Extension Compatibility**: Map diagnostic severity level 8 as error for improved C# extension integration
